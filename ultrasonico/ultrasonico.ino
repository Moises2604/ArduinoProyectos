 ...
 int trigger = 3;           // declaramos la palabra trigger como un tipo entero y al mismo tiempo reemplaza al pin 9
 int echo = 2;           // declaramos la palabra echo como un tipo entero y al mismo tiempo reemplaza al pin 8
